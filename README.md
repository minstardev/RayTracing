...
.\Release\rtweekend.exe > ..\output\image.ppm
```

## 결과물 확인
`output/image.ppm` 파일을 VS Code의 "PBM/PPM/PGM Viewer" 확장으로 열면 바로 미리보기가 됩니다.

## 진행 순서 메모
- [ ] Ch1-2: 기본 세팅 + PPM 출력 (완료된 상태로 시작)
- [ ] Ch3: ray.h 추가
